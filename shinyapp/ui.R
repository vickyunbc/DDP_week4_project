#
# We are going to develop a shiny app which will serve the purpose of completing the week4 project of DDP at Coursera
## Motorscars dataset (mtcars) will be used for this app and regression analysis will be done and finally the app will be published
## on github
...
shinyUI(
  navbarPage("Shiny Application",
             ...
             tabPanel("Go back to my Github repository",
                      a("https://github.com/vickyunbc/DDP_Week4_project"),
                      hr(),
                      h4("How is the app look like :)"),
                      h4("The name of repository is Developing Data Products Week 4 Course Project")
             )
  )
)
